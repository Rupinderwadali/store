...
//Enqueue Theme Specific Styling
function store_enqueue_woocommerce_style(){
	wp_register_style( 'store-woocommerce-css', get_template_directory_uri() . '/assets/css/woocommerce.css' );
	
	if ( class_exists( 'woocommerce' ) ) {
		wp_enqueue_style( 'store-woocommerce-css' );
	}
}
add_action( 'wp_enqueue_scripts', 'store_enqueue_woocommerce_style' );
